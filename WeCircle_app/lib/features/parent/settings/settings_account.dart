...
class _SettingsAccountState extends State<SettingsAccount> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              isArabic ? 'حدث خطأ أثناء حفظ التعديلات، يرجى المحاولة لاحقاً' : 'An error occurred while saving changes, please try again later',
              style: GoogleFonts.cairo(fontWeight: FontWeight.bold),
            ),
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    try {
      ...
      if (image != null) {
        // Dismiss the picker bottom sheet first
        Navigator.pop(context);
        ...
        if (response.data['success'] == true) {
          ...
          ProfileNotifier.parentPhoto.value = dataUrl;
        } else {
          throw Exception();
        }
      }
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              isArabic ? 'حدث خطأ أثناء رفع وتحديث الصورة الشخصية تلقائياً' : 'An error occurred while uploading and updating your profile picture',
              style: GoogleFonts.cairo(fontWeight: FontWeight.bold),
            ),
            backgroundColor: AppColors.rose,
          ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  isArabic 
                      ? 'اختر طريقة رفع صورتك الشخصية لتسجيلها في لوحة التحكم وتكون مربوطة بأطفالك'
                      : 'Select a method to upload your profile photo to register it in the portal and link it with your children',
                  style: GoogleFonts.cairo(
                    fontSize: 12.sp,
                    ...
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Icon(Icons.camera_enhance_rounded, color: AppColors.primary, size: 32.r),
                    ...
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Icon(Icons.photo_library_rounded, color: AppColors.purple, size: 32.r),
                              SizedBox(height: 12.h),
                              Text(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: isDark ? const Color(0xFF2D2D3F) : AppColors.border, width: 4.r),
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: AppColors.primary,
                          shape: BoxShape.circle,
                          border: Border.all(color: isDark ? const Color(0xFF1E1E2C) : Colors.white, width: 2.r),
                        ),
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            fillColor: enabled 
                ...
                : (isDark ? const Color(0xFF2D2D3F).withOpacity(0.5) : AppColors.border.withOpacity(0.3)),
            ...
            disabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12.r),
              borderSide: BorderSide(color: isDark ? const Color(0xFF2D2D3F).withOpacity(0.5) : AppColors.border.withOpacity(0.5)),
            ),
            contentPadding:
